...
|:---:|---|---|---|
| [ ] | **1. Core Foundation** | **1. Frontend Base Setup** | • Install Tailwind CSS, Zustand, Framer Motion.<br>• Create global styles (`index.css`) for Strict Dark Mode.<br>• Build `Navbar` and `Footer` components. |
