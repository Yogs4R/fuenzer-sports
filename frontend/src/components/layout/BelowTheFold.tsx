    ...
    <div className="w-full mt-32 relative z-10 flex flex-col items-center">
      ...
      <motion.div {...scrollRevealProps} className="w-full max-w-6xl mx-auto mb-32 px-4 relative">
        <div className="flex flex-col items-center justify-center text-center mb-8 relative w-full px-4">
          ...
          >
            <span>{t.components.belowTheFold.currentStandings.viewAll}</span>
      ...
      <motion.div {...scrollRevealProps} className="w-full max-w-6xl mx-auto px-4 mb-32 flex flex-col items-center">
        <div className="text-center mb-16 max-w-2xl">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            {t.components.belowTheFold.features.subtitle}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          ...
          <div className="bg-bg-1 border border-white/5 hover:border-primary-cyan/30 rounded-3xl p-8 transition-all shadow-2xl relative overflow-hidden group">
            ...
            <h3 className="text-xl font-bold text-white mb-4">{t.components.belowTheFold.features.aiTitle}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              {t.components.belowTheFold.features.aiDesc}
            </p>
          </div>
          ...
          <div className="bg-bg-1 border border-white/5 hover:border-primary-cyan/30 rounded-3xl p-8 transition-all shadow-2xl relative overflow-hidden group">
            ...
            <h3 className="text-xl font-bold text-white mb-4">{t.components.belowTheFold.features.liveTitle}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              {t.components.belowTheFold.features.liveDesc}
            </p>
          </div>
          ...
          <div className="bg-bg-1 border border-white/5 hover:border-primary-cyan/30 rounded-3xl p-8 transition-all shadow-2xl relative overflow-hidden group">
            ...
            <h3 className="text-xl font-bold text-white mb-4">{t.components.belowTheFold.features.chartsTitle}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              {t.components.belowTheFold.features.chartsDesc}
            </p>
          </div>
        </div>
      </motion.div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 px-4 items-center">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed mb-8 text-sm">
              {t.components.belowTheFold.whyChooseUs.desc}
            </p>
            <ul className="space-y-4">
              {[t.components.belowTheFold.whyChooseUs.feat1, t.components.belowTheFold.whyChooseUs.feat2, t.components.belowTheFold.whyChooseUs.feat3].map((feature, i) => (
          ...
          <div className="bg-bg-1 border border-white/5 rounded-3xl p-8 relative overflow-hidden shadow-2xl">
            ...
            <h3 className="text-xl font-bold mb-4 text-white">{t.components.belowTheFold.whyChooseUs.nextGenTitle}</h3>
            <p className="text-gray-400 text-sm leading-relaxed relative z-10">
              {t.components.belowTheFold.whyChooseUs.nextGenDesc}
            </p>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div {...scrollRevealProps} className="w-full max-w-4xl mx-auto px-4 mb-32">
        <div className="bg-linear-to-r from-bg-1 to-bg-1/40 border border-white/10 rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden group">
          ...
          <p className="text-gray-400 text-sm max-w-lg mx-auto mb-8 leading-relaxed">
            {t.components.belowTheFold.cta.subtitle}
          </p>
          <button 
