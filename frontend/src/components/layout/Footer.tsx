    ...
    <footer className="w-full border-t border-white/5 bg-bg-0 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-white/5">
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-2.5 text-sm text-gray-400">
            ...
            <li>
              <a href="/standings" onClick={(e) => handleNavigation(e, '/standings')} className="hover:text-primary-cyan transition-colors">{t.navbar.standings}</a>
            </li>
            <li>
              <a href="/history" onClick={(e) => handleNavigation(e, '/history')} className="hover:text-primary-cyan transition-colors">{t.navbar.history}</a>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-2.5 text-sm text-gray-400">
            ...
            <li>
              <a href="/privacy" onClick={(e) => handleNavigation(e, '/privacy')} className="hover:text-primary-cyan transition-colors">{t.pages.privacy.title}</a>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 text-sm text-gray-400">
            ...
            >
              ...
              <span>{t.components.footer.githubRepo}</span>
            </a>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-500 gap-4">
        ...
        <div className="flex items-center gap-6">
          <span>{t.components.footer.version} 0.0.1</span>
          <span className="flex items-center gap-1.5">
            {t.components.footer.serverStatus} 
            <span className="flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
              <span className="text-emerald-500 font-semibold">{t.components.footer.online}</span>
            </span>
          </span>
        </div>
      </div>
